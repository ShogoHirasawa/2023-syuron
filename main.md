...
本研究を通じて、インターネットが断絶された環境でも、スマートフォンブラウザ経由でハザードマップを閲覧できるシステムを構築した。このシステムを発展させ活用することで、災害後の対応を迅速化できる可能性を示唆できる。

- データをオフラインで集約することで、紙データで入力していた情報をGISデータとして扱える様になる
